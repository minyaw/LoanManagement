...
export default class App extends Component {
  ...
  render() {
    const { menuOpen, widthArr, loading, item, isVisible, showImg, imageList, imageIndex, bankReceipt, receiptId, showReceipt, selectedBankSlip, receiptUri } = this.state;
    const { cust_id, sales_id } = this.props;
    if (item) {
      return (
        <Drawer
                    ...
                    >
                      {
                        !showImg ? (
                          <ScrollView horizontal={true}>
                            <View>
                              <Table borderStyle={{borderColor: 'transparent'}}>
                                <Row data={InfoHeaderList} widthArr={widthArr} style={styles.header} textStyle={styles.text}/>
                              </Table>
                              <ScrollView>
                                  {
